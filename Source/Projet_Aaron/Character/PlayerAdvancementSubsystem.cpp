...
void UPlayerAdvancementSubsystem::ResetAdvancement()
{
	...
	unlockableAbilities = { {"EnvironmentalScan",true}, {"MovementDetector",false} ,{"ParalysingDartGun",false} ,{"WeakeningDartGun",true} ,{"SoundImitation",false} ,{"OpticCamouflage",false} ,{"FertilizerGun",false},{"Hound",false},{"GrowingRoots",false},{"BarkCovering",false},{"Tracker",false},{"TimeSlow",false},{"Glider",false},{"PoweredBoots",false},{"EmpoweredDash",false},{"PheromonesRelease",false},{"Allergy",true},{"Hallucination",false},{"FastSwimming",false},{"BiologicalRegeneration",false},{"ToughSkin",true},{"HeartContractrion",false} };
	metroidvaniaAbilities = { {"NightVision",false}, {"Grapnel",true} ,{"Gills",true},{"ExtremeTemperaturesResistance",false},{"StickyFeet",false} };
